...
{
    public partial class Form_NganKe : Form
    {
        bool Them = false;
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (Them)
            {
                try
                {
                    kq = nkbusiness.ThemNganKe(ref err, txtTenNK.Text, int.Parse(txtSucChua.Text));
                    if (kq)
                    {
            ...
            else
            {
                ...
                dgvDanhSachNganKe.Rows[r].Cells[0].Value.ToString();
                // Câu lệnh SQL 
                kq = nkbusiness.CapNhatNganKe(ref err, int.Parse(txtMaNganKe.Text), txtTenNK.Text, int.Parse(txtSucChua.Text));
                if (kq)
                {
                    // Load lại dữ liệu trên DataGridView 
                    LoadNganKe();
        ...
        private void dgvDanhSachNganKe_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            this.txtTenNK.Text = dgvDanhSachNganKe.Rows[r].Cells[1].Value.ToString();
