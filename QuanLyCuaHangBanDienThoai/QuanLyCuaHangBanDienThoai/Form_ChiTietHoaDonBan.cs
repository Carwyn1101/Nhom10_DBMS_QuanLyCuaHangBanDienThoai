...
namespace QuanLyCuaHangBanDienThoai
{
    public partial class Form_ChiTietHoaDonBan : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            this.txtTongGiaTriBan.ResetText();
            this.txtMaDienThoai.ResetText();
            this.txtSoLuongBan.ResetText();
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (traloi == DialogResult.Yes)
                {
                    ...
                    kq = cthdbbusiness.XoaChiTietHoaDonBan(ref err, txtMaHoaDonBan.Text, txtMaDienThoai.Text);
                    if (kq)
                    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (Them)
            {
                try
                {
                    kq = cthdbbusiness.ThemChiTietHoaDonBan(ref err, txtSoLuongBan.Text, txtMaHoaDonBan.Text, txtMaDienThoai.Text, txtTongGiaTriBan.Text);
                    if (kq)
                    {
            ...
            else
            {
                ...
                dgvDanhSachChiTietHoaDonBan.Rows[r].Cells[0].Value.ToString();
                // Câu lệnh SQL 
                kq = cthdbbusiness.CapNhatChiTietHoaDonBan(ref err, txtSoLuongBan.Text, txtMaHoaDonBan.Text, txtMaDienThoai.Text, txtTongGiaTriBan.Text);
                if (kq)
                {
                    // Load lại dữ liệu trên DataGridView 
                    LoadChiTietHoaDonBan();
        ...
        void LoadChiTietHoaDonBan()
        {
            try
            {
                ...
                // Đặt tên cột
                dgvDanhSachChiTietHoaDonBan.Columns[0].HeaderText = "Mã hóa đơn bán";
                dgvDanhSachChiTietHoaDonBan.Columns[1].HeaderText = "Mã điện thoại";
                dgvDanhSachChiTietHoaDonBan.Columns[2].HeaderText = "Số lượng bán";
                dgvDanhSachChiTietHoaDonBan.Columns[3].HeaderText = "Tổng giá trị bán";
        ...
        private void Form_ChiTietHoaDonBan_Load(object sender, EventArgs e)
        {
            LoadChiTietHoaDonBan();
            LoadHoaDonBan();
        }
        ...
        private void dgvDanhSachChiTietHoaDonBan_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {   //khi click record trong dgvCTDV thì thông tin sẽ đc đưa lên các textbox và combobox
                int r = dgvDanhSachChiTietHoaDonBan.CurrentCell.RowIndex;
                //hiển thị 
                this.txtSoLuongBan.Text = dgvDanhSachChiTietHoaDonBan.Rows[r].Cells[2].Value.ToString();
                this.txtMaHoaDonBan.Text = dgvDanhSachChiTietHoaDonBan.Rows[r].Cells[0].Value.ToString();
                this.txtMaDienThoai.Text = dgvDanhSachChiTietHoaDonBan.Rows[r].Cells[1].Value.ToString();
                this.txtTongGiaTriBan.Text = dgvDanhSachChiTietHoaDonBan.Rows[r].Cells[3].Value.ToString();
            }
